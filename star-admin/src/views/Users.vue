    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
                        ...
                        <div class="col-lg-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <el-table id="table" :data="tableData" width="100%">
                                        <el-table-column
                                                prop="username"
                                                label="Username"
                                                custom
                                        ...
                                        <el-table-column
                                            ...
                                            <template slot-scope="props">
                                                ...
                                                <button type='button' value="DISABLE"
                                                        ...
                                                        v-if="props.row.status == 'ENABLED'">Disable
                                                </button>
            ...
            <div id="productModal" class="product-modal" ref="modal">
                <div class="product-modal__content">
                    <span class="close product-modal__close" id="close">x</span>
                    <div class="modal-body product-modal__body">
                        <div class="form-group">
                            <div class="form-group">
                                <label>Username</label>
    ...
    export default {
        ...
        methods: {
            loadUsers(){
                ...
                // let btn = document.getElementById("table").getElementsByClassName('statusBtn');
...
//                    let flipBtn = document.querySelector('#changeStatus');
...
//                                document.userRegistration.reset();
                            ...
                            // console.log(document.querySelector('#createUsername').text = 'clear')
                        }
                    }
                    catch (err) {
                        console.log(err);
...
//                console.log(ev.srcElement.getAttribute("value"));
                ...
                if ("ENABLE" === val) {
                    ...
                    statusRequest.onreadystatechange = function (v) {
                        if (statusRequest.readyState == 4) {
                            // console.log(info);
                            // console.log(statusRequest.response);
                ...
                if ("DISABLE" === val) {
                    //ev.srcElement.innerHTML = "ENABLE";
            ...
            changeUser: function (targetUserIndex) {
                // console.log(targetUserIndex.username);
                let paramsUser = {
